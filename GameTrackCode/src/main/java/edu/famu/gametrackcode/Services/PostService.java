...
import edu.famu.gametrackcode.Model.RestPost;
...
public class PostService {
    ...
    protected final Log logger = (Log) LogFxactory.getLog(this.getClass());
    ...
    public void updatePost(String id, Map<String, Object> updateValues) throws ParseException, ParseException {
